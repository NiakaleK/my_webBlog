...
if (isset($_POST['Titre']) && isset($_POST['theme']) && isset($_POST['contenu']) && isset($_POST['liens_type']) && isset($_SESSION['login']) && isset($_POST['tags'])) {
	...
	$query_billets=$dtb->prepare('INSERT INTO billets_attente (id_user, title, id_genre, login, content, liens, liens_type, tags, created) VALUES (:id, :titre, :theme, :auteur, :contenu, :liens, :liens_type, :tags, NOW())');
	...
	echo 'L\'article "' . $_POST['Titre'] . '" a bien été envoyé à l\'administration ! :)';
