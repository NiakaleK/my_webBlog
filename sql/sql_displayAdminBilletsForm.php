...
if (isset($_SESSION['login']) && !empty($_SESSION['login'])) {
	...
	if ($dataGet['id_type'] == 1 || $dataGet['id_type'] == 2) {
		...
		echo '<br><br><br>Merci de bien vouloir consulter les chartes pour connaître les droits~';
	}
}
else {
	echo '<br><br><br>Merci de bien vouloir consulter les chartes afin de connaître les droits~';
}
?>
